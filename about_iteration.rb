...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It can take an argument and a block and passes the argument as an accumulator value and element. 
    # 1 is the initial value for product.
    # At the end of the iteration, the final value for product is the return value for the method. 
  end
